...
namespace MasterStart\TotalSendSMS;

use GuzzleHttp\Client;
use GuzzleHttp\Psr7\Request;
use Psr\Http\Message\RequestInterface;

class TotalSendSMSClient
{
    /**
     * @var Client
     */
     ...
     * @var string
     */
    protected $uri = 'http://smsapi.totalsend.com';

    /**
     * @var string
     */
    protected $useragent = 'masterstart/php-totalsend-sms';
     ...
     *
     * ```php
     * $response = $client->sendMessage('+27000000000', 'This is my message content!');
     * ```
     *
     * @param string $to
